  ...
  return (
    <div className="bg-[#F0F3F6] min-h-screen">
      <main className="pb-25">
        ...
        {/* Apply Coupon */}
        <div className="apply-coupon-button w-full flex justify-between items-center pl-4 py-3 bg-white mt-4 font-medium text-sm shadow-lg flex-row">
          <div className="flex items-center gap-3">
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-2xl text-red-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className="total-amount w-full px-4 py-3 bg-white mt-4 shadow-lg">
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium text-sm">{deliveryFee.toFixed(2)} AED</span>
            </div>
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
